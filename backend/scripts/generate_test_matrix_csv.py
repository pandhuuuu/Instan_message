...
Covers all 70 Test Scenarios (60 Automated Integration Tests + 10 Manual GUI Scenarios)
...
def generate_csv(output_file):
    ...
    print(f"[OK] Total Scenarios: {len(TEST_CASES)} (60 Automated + 10 Manual GUI)")
